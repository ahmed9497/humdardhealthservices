...
import { deleteUser, fetchStaff, fetchUsers } from '../../services/helper.service';
...
const StaffListing = () => {
    ...
    const columns = [
        ...
        },
        {
            title: 'Sibilings',
            key: '_id',
            render: text => <div>{text.brothers} Bro-{text.sisters} Sis</div>,
            // ...getColumnSearchProps('serviceType'),
            // sorter: (a, b) => a.serviceType.length - b.serviceType.length,
            // sortDirections: ['descend', 'ascend'],
        },
        ...
        // },
        {
            ...
            render: (text, record) => (
                <Space size="middle">
                    {/* <Button type='link' onClick={()=>navigate(`/dashboard/users/edit/${encodeURIComponent(btoa(JSON.stringify(record)))}`)}>Edit</Button> */}
                    <div>
    ...
    return (
        <Fragment>
            <Row justify='space-between'>
                <Col>
                    <Title level={2}>Staff Listing</Title>
                </Col>
                <Col>
                    <Button type="primary" block ghost onClick={()=>navigate('/dashboard/staff/add')}>
                        Add Staff
                    </Button>
                </Col>
            </Row>
